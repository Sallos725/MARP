...
export const diagnosticsCSS=`.marp-summary{display:flex;flex-wrap:wrap;gap:8px;margin:12px 0}.marp-pill{padding:4px 10px;border:1px solid var(--m-border);border-radius:999px;font-size:13px;background:var(--m-sunken)}.marp-run{margin:16px 0;padding:14px;border:1px solid var(--m-border);border-radius:12px;background:var(--m-sunken);overflow-wrap:anywhere}.marp-run summary{cursor:pointer;min-height:44px;padding:10px 0}.marp-waterfall-row{margin:16px 0}.marp-row-label{display:flex;flex-wrap:wrap;justify-content:space-between;gap:8px}.marp-track{height:12px;border-radius:6px;background:var(--m-sunken);border:1px solid var(--m-border);position:relative;overflow:hidden;margin-top:6px}.marp-bar{position:absolute;height:100%;border-radius:6px;background:var(--m-world)}.marp-waterfall-row[data-agent=plot] .marp-bar{background:var(--m-plot)}.marp-waterfall-row[data-agent=character] .marp-bar{background:var(--m-char)}.marp-waterfall-row[data-state=error] .marp-bar{background:var(--m-err)}.marp-error{color:var(--m-err)!important}.marp-shell summary:focus-visible{outline:2px solid var(--m-accent)}.marp-shell .marp-records{padding:0;list-style:none}.marp-shell .marp-records>li{margin:10px 0}.marp-shell .marp-muted{color:var(--m-muted);font-size:13px}`;
